...
1. Choose _Launch Stack_ for your preferred region to deploy only the toolkit application into your AWS account. This action does not deploy any agents.
